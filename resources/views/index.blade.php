...
@section('top')
    ...
    <div id="owl-demo" class="owl-carousel owl-theme" style="background-color: #303F9F;">
        <div class="item" align="center">
            <img src="{{ asset('assets/images/slide1.png') }}" style="height:auto;width:270px; margin-top: 10px;" alt="slider-image">
            <div class="carousel-caption">
                <h2 style="color: #333;"></h2>
            </div>
        </div>
        <div class="item" align="center"><img src="{{ asset('assets/images/slide2.png') }}" style="height:auto;width:270px; margin-top: 10px;" alt="slider-image">
        </div>
        <div class="item" align="center"><img src="{{ asset('assets/images/slide3.png') }}" style="height:auto;width:270px; margin-top: 10px;" alt="slider-image">
        </div>
    </div>
    <!-- //Carousel End -->
@stop
