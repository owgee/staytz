...
<section class="content-header">
                <h1>Images for {{ $facility->name}}</h1>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li>Images for {{ $facility->name}}</li>
                </ol>
            </section>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div style="height: 280px; overflow: hidden;">
                                           <img src="{{ asset('uploads/files/'.$image->path) }}" style="width:100%; min-height:280px"> 
                                        </div>
                                        <h4>{{ $image->description }}</h4>
                                        <a href="{{ URL::to('admin/listings/'.$facility->id.'/image/'.$image->id.'/delete') }}"><button class="btn btn-danger">DELETE</button></a>
                                    </div>
                                    @endforeach
                                </div>
                                <br>
                                <hr>
                                <div class="row">
                                    {!! Form::open(array('url' => URL::to('admin/listings/'.$facility->id.'/images/create'), 'method' => 'post', 'id'=>'fileupload', 'files'=> true)) !!}
                                        ...
                                        <div class="row fileupload-buttonbar">
                                            <div class="col-lg-12">
                                                ...
                                                <a href="{{ URL::to('admin/listings/all')}}" class="btn btn-primary pull-right">
    ...
    <script>
        $( document ).ready(function() {
            $('#fileupload').fileupload({
                url: '{{URL::to('admin/listings/'.$facility->id.'/images/create')}}',
                dataType: 'json',
                maxNumberOfFiles: 8
            });
        });
