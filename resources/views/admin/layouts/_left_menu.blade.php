<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/listings/*') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/listings/all') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/listings/all') }}">
                    <i class="fa fa-angle-double-right"></i>
                    All
                </a>
            </li>
            <li {!! (Request::is('admin/listings/hotels') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/listings/hotels') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Hotels and Lodges
                </a>
            </li>
            <li {!! (Request::is('admin/listings/guesthouses') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/listings/guesthouses') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Guest Houses
                </a>
            </li>
            <li {!! (Request::is('admin/listings/conferencehalls') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/listings/conferencehalls') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Conference halls
                </a>
            </li>
            <li {!! (Request::is('admin/listings/apartments') ? 'class="active"' : '') !!}>
                <a href="{{ URL::to('admin/listings/apartments') }}">
                    <i class="fa fa-angle-double-right"></i>
                    Apartments
                </a>
            </li>
    ...
    <li {!! (Request::is('admin/places/*') ? 'class="active"' : '') !!}>
        <a href="#">
    ...
    <li {!! (Request::is('admin/notifications/*') || Request::is('admin/notifications') ? 'class="active"' : '') !!}>
        <a href="#">
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/notifications/create') ? 'class="active"' : '') !!}>
    ...
    <li {!! (Request::is('admin/users') || Request::is('admin/users/create') || Request::is('admin/users/*') || Request::is('admin/deleted_users') ? 'class="active"' : '') !!}>
        ...
        <ul class="sub-menu">
            ...
            <li {!! (Request::is('admin/deleted_users') ? 'class="hidden" id="activex"' : 'class="hidden"') !!}>
