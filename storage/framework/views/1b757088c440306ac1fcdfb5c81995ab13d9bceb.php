...
<body>
                    ...
                    <li class="pull-right">
                        <ul class="list-inline icon-position">
                            <li>
                                ...
                                <label class="hidden-xs"><a href="mailto:staytz@staytz.com" style="color: #303F9F;">staytz@staytz.com</a></label>
                            </li>
                            <li>
                                <a href="tel:"><i class="livicon" data-name="phone" data-size="20" data-loop="true" data-c="#303F9F" data-hc="#fff"></i></a>
                                <label class="hidden-xs"><a href="tel:" style="color: #303F9F;">+255 717 420 012</a></label>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="container footer-text">
            ...
            <div class="col-sm-4" align="center">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="livicon icon4 icon3" data-name="cellphone" data-size="18" data-loop="true" data-c="#ccc" data-hc="#ccc"></i>Phone: +255 717 420 012, +255 753 387 833</li>
    ...
    <div class="copyright">
        ...
        <p align="center">Staytz &copy; <?php echo e(date("Y",time())); ?></p>
        </div>
    </div>
